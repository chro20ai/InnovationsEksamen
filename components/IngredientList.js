...
//Henter ingredienser
    ...
    if(ingredients){
        //Laver et array med alle values i ingredients
        const temp = Object.values(ingredients)
        ingredientarray = []
        //Smider ingredienserne over i ingredientarray med små bogstaver
...
// keyextractor sørger for at handleselectIngredient funktionen får det rigtige id
    ...
    <ImageBackground source={require("../assets/opacity.png")}  style={styles.image} >
        ...
        <FlatList style={styles.flatlist}
            ...
            //Data sættes til at være det oprettede array med ingredients
